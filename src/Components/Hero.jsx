    ...
    return (
        ...
        id="hero">
            <div className="flex-1 text-center md:text-left z-[1]">
                ...
                <p className="w-full text-xs font-light text-neutral-50 landing-5 my-6 lg:w-[38vw] md:text-sm md:leading-6 md:my-8">{tagline}</p>
                <button className="primary-btn">Contact Me</button>
            </div>

            <div className="flex gap-2 justify-center md:gap-3 lg:gap-5 z-[1]">
                <div className="w-[403px] bg-gradient-to-br from-blue-950 t0-slate-900 rounded-lg border border-blue-950 p-6">
...
const InfoTile=({icon,text})=>{
    return <div className="flex items-center gap-4 bg-cardbg p-4 mt-3 rounded-md">
        {icon}
